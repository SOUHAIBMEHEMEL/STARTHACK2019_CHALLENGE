function Tetris(canvas,context,choix){ /*gére la Tetris Complète*/
   console.log(choix);
    ...
    if (But <= 0) {
        ...
        document.getElementById("but").innerText = "Goal: '"+But+"'\n\n" ;
        document.getElementById("Lignes").innerText = "Lines: '"+nbrTotaleLigneSup+"'\n\n" ;
        document.getElementById("niveau").innerText="Level: '"+(niveau+1)+"'\n\n";
    };
